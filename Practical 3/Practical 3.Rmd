---
title: "Sentiment classification with Keras"
params:
  answers: false
mainfont: Arial
fontsize: 12pt
...
```{r glove vectors, message = FALSE, warning = FALSE, include = TRUE}
...
```{r 2, message = FALSE, warning = FALSE, include = params$answers}
...
```{r 3, message = FALSE, warning = FALSE, include = params$answers}
max_words <- 1e4
maxlen    <- 60
dim_size  <- 300
```
...
```{r 4, message = FALSE, warning = FALSE, include = params$answers}
...
```{r 5, message = FALSE, warning = FALSE, include = params$answers}
...
```{r 6, message = FALSE, warning = FALSE, include = params$answers}
# unlist word indices
...
```{r 8, message = FALSE, warning = FALSE, include = params$answers}
...
```{r 10, message = FALSE, warning = FALSE, include = params$answers}
...
```{r 11, message = FALSE, warning = FALSE, include = params$answers}
